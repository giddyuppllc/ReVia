      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 z-[70] flex h-full w-full w-full sm:max-w-md flex-col border-l border-neutral-200 bg-white"
          >
            {/* Header */}
            ...
            {items.length > 0 && (
              <div className="border-t border-neutral-200 px-6 py-4 space-y-3">
                ...
                <div className="rounded-xl bg-sky-50/80 border border-sky-200/50 p-3">
