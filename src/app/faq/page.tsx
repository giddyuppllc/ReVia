...
const faqData = [
  ...
  { q: "Do you offer Certificates of Analysis (COAs)?", a: "Yes. COAs are available for every batch upon request. Contact orders@revialife.com with your order number and we'll provide batch-specific documentation." },
  ...
  { q: "What is a wire transfer and how do I send one?", a: "A wire transfer is a bank-to-bank electronic money transfer. After you place your order with Wire Transfer selected, you'll receive an email with our routing number, account number, and your invoice number. Log into your bank's online banking (or visit a branch) and initiate a domestic wire to that account. Include your invoice number in the memo so we can match the payment to your order. Domestic wires usually clear the same business day. Wire fees vary by bank — typically $15–$35 — and are paid by the sender. If you've never sent one, your bank's customer service can walk you through it." },
  { q: "Do you offer wholesale pricing?", a: "Yes. Contact us at info@revialife.com for B2B and wholesale pricing inquiries. We offer tiered pricing for research institutions and distributors." },
  ...
  { q: "Can I get research guidance?", a: "We can answer general questions about our products, storage, and handling. Contact info@revialife.com. We cannot provide specific research protocols or dosing guidance." },
