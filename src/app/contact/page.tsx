...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with the ReVia team for questions about orders, products, or anything else.",
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full sm:w-auto rounded-xl bg-sky-400 px-8 py-3 text-sm font-semibold text-white transition hover:bg-sky-500"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="space-y-5">
          {/* Contact info + hours — single card */}
          <div className="rounded-2xl border border-sky-200/40 bg-white/80 backdrop-blur-sm p-6 shadow-sm space-y-6">
            ...
            <p className="text-xs text-stone-400 leading-relaxed">
              ...
              urgent order issues, include your order number in the message.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  label: "Shipping Info",
                  desc: "Rates, times, and tracking",
                },
                {
                  href: "/policies/refunds",
                  label: "Return Policy",
                  desc: "Eligibility and refunds",
                },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                  ...
                  >
                    <div>
                      <p className="text-sm font-medium text-stone-700 group-hover:text-sky-600 transition-colors">
                        {link.label}
                      </p>
